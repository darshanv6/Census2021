                ...
                database.push().setValue(datamap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isSuccessful()){
                            Toast.makeText(CensusActivity.this, "stored successfully",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(CensusActivity.this, "error occured",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
